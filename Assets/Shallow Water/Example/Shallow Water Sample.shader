...
Shader "Skywater/Shallow Water Sample"
{
	Properties
	{
		...
		[PerRendererData][NoScaleOffset]_ShallowWaveBuffer("Shallow Wave Buffer", 2D) = "black" {}
		_ShallowWaveResolution("ShallowWaveResolution", Vector) = (512,512,0,0)
		_ShallowWaveVertHeight("Shallow Wave Vert Height", Float) = 1
		_ShallowWaveNormalStrength("Shallow Wave Normal Strength", Float) = 1
	...
	SubShader
	{
		...
		uniform sampler2D _ShallowWaveBuffer;
		uniform float _ShallowWaveVertHeight;
		uniform float2 _ShallowWaveResolution;
		uniform float4 _ShallowWaveBuffer_ST;
		uniform float _ShallowWaveNormalStrength;
		...
		{
			float2 uv_ShallowWaveBuffer2_g1 = v.texcoord;
			half3 appendResult18_g1 = (half3(0.0 , ( saturate( tex2Dlod( _ShallowWaveBuffer, float4( uv_ShallowWaveBuffer2_g1, 0, 0.0) ).r ) * _ShallowWaveVertHeight ) , 0.0));
			v.vertex.xyz += appendResult18_g1;
			float2 resolution7_g1 = _ShallowWaveResolution;
			sampler2D tex7_g1 = _ShallowWaveBuffer;
			float2 uv0_ShallowWaveBuffer = v.texcoord.xy * _ShallowWaveBuffer_ST.xy + _ShallowWaveBuffer_ST.zw;
			float2 uv7_g1 = uv0_ShallowWaveBuffer;
			float normalStrength7_g1 = _ShallowWaveNormalStrength;
			float3 localShallowWaveNormals7_g1 = ShallowWaveNormals7_g1( resolution7_g1 , tex7_g1 , uv7_g1 , normalStrength7_g1 );
			...
			half3 tangentTobjectDir30_g1 = normalize( mul( unity_WorldToObject, float4( mul( ase_tangentToWorldFast, localShallowWaveNormals7_g1 ), 0 ) ).xyz );
			v.normal = tangentTobjectDir30_g1;
		}
		...
		void surf( Input i , inout SurfaceOutputStandardSpecular o )
		{
			...
			float2 resolution7_g1 = _ShallowWaveResolution;
			sampler2D tex7_g1 = _ShallowWaveBuffer;
			float2 uv0_ShallowWaveBuffer = i.uv_texcoord * _ShallowWaveBuffer_ST.xy + _ShallowWaveBuffer_ST.zw;
			float2 uv7_g1 = uv0_ShallowWaveBuffer;
			float normalStrength7_g1 = _ShallowWaveNormalStrength;
			float3 localShallowWaveNormals7_g1 = ShallowWaveNormals7_g1( resolution7_g1 , tex7_g1 , uv7_g1 , normalStrength7_g1 );
			half3 temp_output_168_0 = BlendNormals( BlendNormals( UnpackScaleNormal( tex2D( _WaterNormal, panner22 ), _NormalScale ) , UnpackScaleNormal( tex2D( _WaterNormal, panner19 ), _NormalScale ) ) , localShallowWaveNormals7_g1 );
			o.Normal = temp_output_168_0;
			...
			float4 screenColor65 = UNITY_SAMPLE_SCREENSPACE_TEXTURE(_GrabTexture,( half3( (ase_grabScreenPosNorm).xy ,  0.0 ) + ( temp_output_168_0 * _Distortion ) ).xy);
...
/*ASEBEGIN
Version=17400
293;177;1805;995;2639.584;1377.535;3.017339;True;False
...
Node;AmplifyShaderEditor.RangedFloatNode;6;-813.7005,-128.1996;Float;False;Property;_WaterDepth;Water Depth;9;0;Create;True;0;0;False;0;0;0.96;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;111;-722.2024,526.6185;Float;False;Property;_FoamDepth;Foam Depth;15;0;Create;True;0;0;False;0;0;0.94;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;112;-531.4025,588.5187;Float;False;Property;_FoamFalloff;Foam Falloff;16;0;Create;True;0;0;False;0;0;-60;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;10;-636.2005,-79.20019;Float;False;Property;_WaterFalloff;Water Falloff;10;0;Create;True;0;0;False;0;0;-0.21;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;12;-697.5002,-417.5007;Float;False;Property;_DeepColor;Deep Color;7;0;Create;True;0;0;False;0;0,0,0,0;0,0.04310166,0.2499982,0;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.CommentaryNode;150;467.1957,-1501.783;Inherit;False;985.6011;418.6005;Get screen color for refraction and disturbe it with normals;6;96;97;98;65;164;165;;1,1,1,1;0;0
...
Node;AmplifyShaderEditor.FunctionNode;167;873.3911,169.6118;Inherit;False;ShallowWaterWaves;19;;1;5c08df36ed3097243a2a64c4ba96e3f2;0;0;3;FLOAT3;27;FLOAT3;0;FLOAT3;31
...
Node;AmplifyShaderEditor.BlendNormalsNode;168;454.11,-885.2317;Inherit;False;0;3;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;2;FLOAT3;0,0,0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.RangedFloatNode;132;914.3978,-199.48;Float;False;Property;_FoamSmoothness;Foam Smoothness;18;0;Create;True;0;0;False;0;0;0.2;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.WireNode;162;1312.293,-894.3823;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;104;753.9969,-565.4819;Float;False;Property;_WaterSpecular;Water Specular;11;0;Create;True;0;0;False;0;0;0.05;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;26;920.1959,-279.1855;Float;False;Property;_WaterSmoothness;Water Smoothness;12;0;Create;True;0;0;False;0;0;0.9;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.StandardSurfaceOutputNode;0;1838.601,-748.1998;Half;False;True;-1;6;ASEMaterialInspector;0;0;StandardSpecular;Skywater/Shallow Water Sample;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;Back;0;False;-1;3;False;-1;False;0;False;-1;0;False;-1;False;0;Translucent;0.5;True;False;0;False;Opaque;;Transparent;All;14;all;True;True;True;True;0;False;-1;False;0;False;-1;255;False;-1;255;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;True;2;2;10;25;False;0.5;True;0;0;False;-1;0;False;-1;0;0;False;-1;0;False;-1;1;False;-1;1;False;-1;0;False;0;0,0,0,0;VertexOffset;True;False;Cylindrical;False;Relative;0;;-1;-1;-1;0;0;False;0;0;False;-1;-1;0;False;-1;0;0;0;False;0.1;False;-1;0;False;-1;16;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;2;FLOAT3;0,0,0;False;3;FLOAT3;0,0,0;False;4;FLOAT;0;False;5;FLOAT;0;False;6;FLOAT3;0,0,0;False;7;FLOAT3;0,0,0;False;8;FLOAT;0;False;9;FLOAT;0;False;10;FLOAT;0;False;13;FLOAT3;0,0,0;False;11;FLOAT3;0,0,0;False;12;FLOAT3;0,0,0;False;14;FLOAT4;0,0,0,0;False;15;FLOAT3;0,0,0;False;0
Node;AmplifyShaderEditor.CommentaryNode;169;748.199,80.02153;Inherit;False;790.9705;528.4622;This shader uses the water sample given with ASE and adds shallow water waves;0;README;1,1,1,1;0;0
...
WireConnection;0;11;167;27
WireConnection;0;12;167;31
ASEEND*/
//CHKSM=B10B76F19E413EB3641EF177BB6B0491143872A6